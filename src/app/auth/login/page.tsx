...
function LoginForm() {
  ...
  useEffect(() => {
    ...
    if (verifySent && verifyEmail) {
      setNotice(`A verification link has been sent to ${verifyEmail}. Please check your inbox and verify your email before logging in.`);
    }
  }, [searchParams]);
          ...
          {success ? (
            ...
            <div className="space-y-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {notice && (
                  <div className="p-3 bg-blue-50 border border-blue-100 rounded-xl text-blue-700 text-sm flex items-start gap-2.5 animate-fadeIn">
